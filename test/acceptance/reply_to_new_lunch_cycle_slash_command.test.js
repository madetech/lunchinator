...
function GivenALunchCycleWithRestaurantsExists(restaurants) {
  lunchCycle = new LunchCycle({ 
    ...
    startsAt: new Date("2020-03-12T00:00:00")})
...
function ThenANewLunchCyclePreviewMessageIsCreated(){
  ...
  const expectedMessage = "Hey {first name}! It’s time to enter the draw for the next cycle of company lunches. Let us know which dates you’ll be available on by reacting with the matching emoji.\n\n" + expected.join("\n");
