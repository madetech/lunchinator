class GenerateSelectedLunchersMessage {
  execute({ lunchCycleWeek, luncher }) {
    ...
    const message = `Congratulations ${luncher.firstName} \:tada\: You have been selected to join the lunchers on \*${lunchCycleWeek.restaurant.date}\*. You will be going to \*${lunchCycleWeek.restaurant.name}\* along with:${listOfLunchers}`;
